        ...
        <div className="rounded-2xl p-8 border border-[var(--border)]" style={{ backgroundColor: "var(--surface)" }}>
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 rounded-full text-black text-sm font-bold font-[var(--font-lato)] tracking-wide transition-all duration-300 gold-gradient btn-pulse disabled:opacity-50 disabled:cursor-not-allowed"
            >
