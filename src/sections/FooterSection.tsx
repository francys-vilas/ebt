export default function FooterSection() {
  const socialLinks = [
    {
      label: "Instagram",
      href: "https://www.instagram.com/_casalbaruc/",
      icon: (
  ...
  return (
    <footer id="contato" className="relative border-t border-[var(--border)] pt-2 bg-[var(--bg)]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 md:py-16">
        ...
        {/* Bottom */}
        <div className="mt-10 md:mt-12 pt-6 border-t border-[var(--border)] flex flex-col sm:flex-row justify-between items-center gap-4">
